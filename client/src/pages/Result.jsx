        ...
        >
            ...
            {!isImageLoaded &&
                <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full  justify-center items-center'>
                    <input onChange={(e) => { setInput(e.target.value) }} value={input} type="text" name="" id="" placeholder='what you want to generate' className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20 placeholder-color' />
                    <button type="submit" className='bg-zinc-900 px-10 sm:px-17 py-3 rounded-full text-white '>Generate</button>
                </div>
            }
